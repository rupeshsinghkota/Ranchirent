...
export const metadata: Metadata = {
  ...
  title: {
    default: "RanchiRent.in | Verified Flats, PG, Shops & Rooms for Rent in Ranchi",
    template: "%s | RanchiRent",
  },
  description: "Find verified 1 BHK, 2 BHK, 3 BHK flats, PG/hostels, independent houses, shops & office spaces for rent in Ranchi. Direct owner contact, no brokerage spam. 500+ verified listings in Lalpur, Bariatu, Morabadi, Kanke Road, Doranda, Hinoo & more.",
  keywords: [
    // Property Types
    ...
    "hostel in Ranchi",
    "paying guest Ranchi",
    "shop for rent in Ranchi",
    "office space for rent Ranchi",
    "commercial space Ranchi",
    "independent house for rent Ranchi",
    "1 RK for rent Ranchi",
    "1 BHK flat in Ranchi",
    "2 BHK flat in Ranchi",
    "3 BHK flat in Ranchi",
    "furnished flat Ranchi",
    "semi furnished flat Ranchi",
    // Tenant Types
    ...
    "boys PG Ranchi",
    "girls PG Ranchi",
    "working professional accommodation Ranchi",
    // Localities
    "flat in Lalpur Ranchi",
    "flat in Bariatu Ranchi",
    "flat in Morabadi Ranchi",
    "flat in Kanke Road Ranchi",
    "flat in Doranda Ranchi",
    "flat in Hinoo Ranchi",
    "flat in Kokar Ranchi",
    "flat in Argora Ranchi",
    "flat in Harmu Ranchi",
    "flat in Ratu Road Ranchi",
    "flat in Ashok Nagar Ranchi",
    "flat in Kadru Ranchi",
    // Generic
    "Ranchi rental property",
    "house for rent in Ranchi",
    "Ranchi rent",
    "RanchiRent",
    "no brokerage flat Ranchi",
    "owner direct flat Ranchi",
  ],
